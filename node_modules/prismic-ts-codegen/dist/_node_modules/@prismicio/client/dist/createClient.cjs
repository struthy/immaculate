...
class Client {
  ...
  async fetch(url, params = {}) {
    ...
    switch (res.status) {
      ...
      case 404: {
        if (res.json === void 0) {
          throw new RepositoryNotFoundError.RepositoryNotFoundError(`Prismic repository not found. Check that "${this.endpoint}" is pointing to the correct repository.`, url, void 0);
        }
