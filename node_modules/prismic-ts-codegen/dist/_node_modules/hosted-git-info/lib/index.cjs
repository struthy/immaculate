...
const hosts$1 = require("./hosts.cjs");
const fromUrl$1 = require("./from-url.cjs");
const parseUrl$1 = require("./parse-url.cjs");
const LRU = index.lruCache;
const hosts = hosts$1.hosts_1;
const fromUrl = fromUrl$1.fromUrl;
const parseUrl = parseUrl$1.parseUrl;
