...
async function toFormData(Body, ct) {
  ...
  const appendFileToFormData = () => {
    const file$1 = new file.File(entryChunks, filename, { type: contentType });
    formData.append(entryName, file$1);
  };
...
//# sourceMappingURL=multipart-parser.cjs.map
