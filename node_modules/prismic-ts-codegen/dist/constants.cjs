...
const CUSTOM_TYPES_DOCUMENTATION_URL = "https://prismic.io/docs/custom-types";
const SHARED_SLICES_DOCUMENTATION_URL = "https://prismic.io/docs/slice";
const FIELD_DOCUMENTATION_URLS = {
...
exports.CUSTOM_TYPES_DOCUMENTATION_URL = CUSTOM_TYPES_DOCUMENTATION_URL;
exports.FIELD_DOCUMENTATION_URLS = FIELD_DOCUMENTATION_URLS;
exports.SHARED_SLICES_DOCUMENTATION_URL = SHARED_SLICES_DOCUMENTATION_URL;
