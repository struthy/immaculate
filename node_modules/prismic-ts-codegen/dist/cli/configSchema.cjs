...
const configSchema = Joi.object({
  repositoryName: Joi.string().when("locales.fetchFromRepository", {
    is: true,
    then: Joi.required()
  ...
  locales: Joi.alternatives(Joi.array().items(Joi.string().required()), Joi.object({
    ids: Joi.array().items(Joi.string().required()),
    fetchFromRepository: Joi.boolean()
  })),
  models: Joi.alternatives(Joi.array().items(Joi.string()), Joi.object({
...
//# sourceMappingURL=configSchema.cjs.map
