 ...
 * @internal
 */
export type CustomTypeCreateHookBase = SliceMachineHook<CustomTypeCreateHookData, CustomTypeCreateHookReturnType>;
/**
 ...
 */
export type CustomTypeCreateHook<TPluginOptions extends SliceMachinePluginOptions = SliceMachinePluginOptions> = ExtendSliceMachineHook<CustomTypeCreateHookBase, TPluginOptions>;
