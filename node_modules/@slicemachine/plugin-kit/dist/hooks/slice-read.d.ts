 ...
 * @internal
 */
export type SliceReadHookBase = SliceMachineHook<SliceReadHookData, SliceReadHookReturnType>;
/**
 ...
 */
export type SliceReadHook<TPluginOptions extends SliceMachinePluginOptions = SliceMachinePluginOptions> = ExtendSliceMachineHook<SliceReadHookBase, TPluginOptions>;
