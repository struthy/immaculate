 ...
 * @internal
 */
export type CustomTypeReadHookBase = SliceMachineHook<CustomTypeReadHookData, CustomTypeReadHookReturnType>;
/**
 ...
 */
export type CustomTypeReadHook<TPluginOptions extends SliceMachinePluginOptions = SliceMachinePluginOptions> = ExtendSliceMachineHook<CustomTypeReadHookBase, TPluginOptions>;
