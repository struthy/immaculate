 ...
 * @internal
 */
export type SliceAssetReadHookBase = SliceMachineHook<SliceAssetReadHookData, SliceAssetReadHookReturnType>;
/**
 ...
 */
export type SliceAssetReadHook<TPluginOptions extends SliceMachinePluginOptions = SliceMachinePluginOptions> = ExtendSliceMachineHook<SliceAssetReadHookBase, TPluginOptions>;
