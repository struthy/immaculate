 ...
 * @internal
 */
export type ProjectEnvironmentReadHookBase = SliceMachineHook<ProjectEnvironmentReadHookData, ProjectEnvironmentReadHookReturnType>;
/**
 ...
 */
export type ProjectEnvironmentReadHook<TPluginOptions extends SliceMachinePluginOptions = SliceMachinePluginOptions> = ExtendSliceMachineHook<ProjectEnvironmentReadHookBase, TPluginOptions>;
