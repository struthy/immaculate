 ...
 * @internal
 */
export type SnippetReadHookBase = SliceMachineHook<SnippetReadHookData, SnippetReadHookReturnType>;
/**
 ...
 */
export type SnippetReadHook<TPluginOptions extends SliceMachinePluginOptions = SliceMachinePluginOptions> = ExtendSliceMachineHook<SnippetReadHookBase, TPluginOptions>;
