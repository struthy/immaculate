 ...
 * @internal
 */
export type ProjectInitHookBase = SliceMachineHook<ProjectInitHookData, ProjectInitHookReturnType>;
/**
 ...
 */
export type ProjectInitHook<TPluginOptions extends SliceMachinePluginOptions = SliceMachinePluginOptions> = ExtendSliceMachineHook<ProjectInitHookBase, TPluginOptions>;
