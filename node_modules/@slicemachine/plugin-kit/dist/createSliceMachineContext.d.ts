 ...
 */
export type SliceMachineContext<TPluginOptions extends Record<string, unknown>> = {
 ...
 */
type CreateSliceMachineContextArgs<TPluginOptions extends Record<string, unknown>> = {
    actions: SliceMachineActions;
    helpers: SliceMachineHelpers;
    project: SliceMachineProject;
 ...
 * @internal
 */
export declare const createSliceMachineContext: <TPluginOptions extends Record<string, unknown>>({ actions, helpers, project, plugin, }: CreateSliceMachineContextArgs<TPluginOptions>) => SliceMachineContext<TPluginOptions>;
export {};
