...
const chunk = require("../utils/chunk.cjs");
...
var Destination = (
  ...
  function() {
    function Destination2() {
      this.name = "amplitude";
      this.type = plugin.PluginType.DESTINATION;
      ...
      return tslib_es6.__awaiter(this, void 0, void 0, function() {
        ...
        return tslib_es6.__generator(this, function(_b) {
          switch (_b.label) {
            case 0:
              this.config = config2;
              this.storageKey = "".concat(constants.STORAGE_PREFIX, "_").concat(this.config.apiKey.substring(0, 10));
    ...
    Destination2.prototype.addToQueue = function() {
      ...
      var tryable = list.filter(function(context) {
        ...
        void _this.fulfillRequest([context], 500, messages.MAX_RETRIES_EXCEEDED_MESSAGE);
        return false;
      });
        ...
        return tslib_es6.__generator(this, function(_a) {
          switch (_a.label) {
            case 0:
              ...
              batches = chunk.chunk(list, this.config.flushQueueSize);
          ...
          switch (_a.label) {
            case 0:
              if (!this.config.apiKey) {
                return [2, this.fulfillRequest(list, 400, messages.MISSING_API_KEY_MESSAGE)];
              }
              payload = {
                ...
                events: list.map(function(context) {
                  ...
                  _a2.extra;
                  var eventWithoutExtra = tslib_es6.__rest(_a2, ["extra"]);
            ...
            case 1:
              _a.trys.push([1, 3, , 4]);
              serverUrl = config.createServerConfig(this.config.serverUrl, this.config.serverZone, this.config.useBatch).serverUrl;
              return [4, this.config.transportProvider.send(serverUrl, payload)];
            case 2:
              res = _a.sent();
              if (res === null) {
                this.fulfillRequest(list, 0, messages.UNEXPECTED_ERROR_MESSAGE);
                return [
                  2
                  /*return*/
                ];
    ...
    Destination2.prototype.handleResponse = function(res, list) {
      ...
      switch (status$1) {
        ...
        default: {
          this.config.loggerProvider.warn(`{code: 0, error: "Status '`.concat(status$1, "' provided for ").concat(list.length, ' events"}'));
    ...
    Destination2.prototype.handleSuccessResponse = function(res, list) {
      this.fulfillRequest(list, res.statusCode, messages.SUCCESS_MESSAGE);
    };
    Destination2.prototype.handleInvalidResponse = function(res, list) {
      var _this = this;
      if (res.body.missingField || res.body.error.startsWith(messages.INVALID_API_KEY)) {
        this.fulfillRequest(list, res.statusCode, res.body.error);
        return;
      }
      var dropIndex = tslib_es6.__spreadArray(tslib_es6.__spreadArray(tslib_es6.__spreadArray(tslib_es6.__spreadArray([], tslib_es6.__read(Object.values(res.body.eventsWithInvalidFields)), false), tslib_es6.__read(Object.values(res.body.eventsWithMissingFields)), false), tslib_es6.__read(Object.values(res.body.eventsWithInvalidIdLengths)), false), tslib_es6.__read(res.body.silencedEvents), false).flat();
      ...
      this.addToQueue.apply(this, tslib_es6.__spreadArray([], tslib_es6.__read(retry), false));
    };
    Destination2.prototype.handlePayloadTooLargeResponse = function(res, list) {
      ...
      this.addToQueue.apply(this, tslib_es6.__spreadArray([], tslib_es6.__read(list), false));
    };
    ...
    Destination2.prototype.handleOtherResponse = function(list) {
      var _this = this;
      this.addToQueue.apply(this, tslib_es6.__spreadArray([], tslib_es6.__read(list.map(function(context) {
    ...
    Destination2.prototype.fulfillRequest = function(list, code, message) {
      ...
      list.forEach(function(context) {
        return context.callback(resultBuilder.buildResult(context.event, code, message));
      });
    };
...
//# sourceMappingURL=destination.cjs.map
