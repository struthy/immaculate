...
exports.NumberMock = {
    ...
    applyPatch(data) {
        ...
        if (data.diff.value.type === "Number") {
            const patched = this.patch(data.diff, !data.content || data.content.__TYPE__ === content_1.FieldContentType
                ? data.content
                : undefined, ((_a = data.config) === null || _a === void 0 ? void 0 : _a.type) === "Number" ? data.config : undefined);
