...
exports.TimestampMock = {
    ...
    applyPatch(data) {
        ...
        if (data.diff.value.type === "Timestamp") {
            const patched = this.patch(data.diff, (0, content_1.isTimestampContent)(data.content) ? data.content : undefined, ((_a = data.config) === null || _a === void 0 ? void 0 : _a.type) === "Timestamp" ? data.config : undefined);
