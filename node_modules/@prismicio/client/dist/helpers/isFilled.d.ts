 ...
 * @returns `true` if `field` is filled, `false` otherwise.
 */
export declare const image: <ThumbnailNames extends string | null = never>(field: ImageField<ThumbnailNames> | null | undefined) => field is import("../types/value/types").Simplify<import("../types/value/image").FilledImageFieldImage & Record<Extract<ThumbnailNames, string>, import("../types/value/image").FilledImageFieldImage>>;
/**
 ...
 * @returns `true` if `field` is filled, `false` otherwise.
 */
export declare const contentRelationship: <TypeEnum = string, LangEnum = string, DataInterface extends unknown = unknown>(field: ContentRelationshipField<TypeEnum, LangEnum, DataInterface> | null | undefined) => field is import("../types/value/contentRelationship").FilledContentRelationshipField<TypeEnum, LangEnum, DataInterface>;
/**
 ...
 * @returns `true` if `field` is filled, `false` otherwise.
 */
export declare const select: <Enum extends string>(field: SelectField<Enum> | undefined) => field is Enum;
/**
 ...
 * @returns `true` if `field` is filled, `false` otherwise.
 */
export declare const embed: <Field extends EmbedField<AnyOEmbed>>(field: Field | null | undefined) => field is Extract<Field, AnyOEmbed & {
    embed_url: string;
    html: string | null;
}>;
/**
 ...
 */
export declare const group: <Fields extends Record<string, string | number | boolean | [] | [Omit<import("../types/value/richText").RTHeading1Node | import("../types/value/richText").RTHeading2Node | import("../types/value/richText").RTHeading3Node | import("../types/value/richText").RTHeading4Node | import("../types/value/richText").RTHeading5Node | import("../types/value/richText").RTHeading6Node, "spans"> & {
    spans: [];
}] | [import("../types/value/richText").RTNode, ...import("../types/value/richText").RTNode[]] | import("../types/value/types").Simplify<import("../types/value/image").EmptyImageFieldImage & Record<never, import("../types/value/image").EmptyImageFieldImage>> | import("../types/value/types").Simplify<import("../types/value/image").FilledImageFieldImage & Record<never, import("../types/value/image").FilledImageFieldImage>> | import("../types/value/link").EmptyLinkField<"Document"> | import("../types/value/contentRelationship").FilledContentRelationshipField<string, string, unknown> | import("../types/value/link").EmptyLinkField<"Any"> | import("../types/value/link").FilledLinkToWebField | import("../types/value/linkToMedia").FilledLinkToMediaField | import("../types/value/link").EmptyLinkField<"Media"> | import("../types/value/types").EmptyObjectField | ({
    type: "photo";
    version: string;
} & {
    url: string;
    width: number;
    height: number;
} & import("../types/value/embed").OEmbedExtra & {
    embed_url: string;
    html: string | null;
}) | ({
    type: "video";
    ...
    embed_url: string;
    html: string | null;
}) | (import("../types/value/embed").LinkOEmbed & import("../types/value/embed").OEmbedExtra & {
    embed_url: string;
    html: string | null;
}) | ({
    type: "rich";
    ...
    latitude: number;
    longitude: number;
} | Record<string, unknown> | [Record<string, AnyRegularField>, ...Record<string, AnyRegularField>[]] | null>>(group: GroupField<Fields> | null | undefined) => group is [Fields, ...Fields[]];
/**
 ...
 */
export declare const sliceZone: <Slices extends Slice<string, Record<string, AnyRegularField>, Record<string, AnyRegularField>> | SharedSlice>(slices: SliceZone<Slices> | null | undefined) => slices is [Slices, ...Slices[]];
