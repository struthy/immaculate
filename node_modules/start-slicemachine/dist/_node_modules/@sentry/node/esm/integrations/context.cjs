...
const nodeContextIntegration = integration.defineIntegration(_nodeContextIntegration);
integration.convertIntegrationFnToClass(INTEGRATION_NAME, nodeContextIntegration);
