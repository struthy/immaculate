...
const metricSummary = require("./metric-summary.cjs");
...
class MetricsAggregator {
  ...
  _flush() {
    ...
    const cutoffSeconds = Math.floor(time.timestampInSeconds()) - constants.DEFAULT_FLUSH_INTERVAL / 1e3 - this._flushShift;
...
//# sourceMappingURL=aggregator.cjs.map
