...
const requestdata = require("../../../utils/esm/requestdata.cjs");
...
const _requestDataIntegration = (options = {}) => {
  const _addRequestData = requestdata.addRequestDataToEvent;
  const _options = {
    ...DEFAULT_OPTIONS,
    ...options,
    include: {
  ...
  return {
    ...
    processEvent(event, _hint, client) {
      ...
      if (transaction) {
        ...
        const [transactionValue] = requestdata.extractPathForTransaction(req, {
          path: true,
...
integration.convertIntegrationFnToClass(INTEGRATION_NAME, requestDataIntegration);
