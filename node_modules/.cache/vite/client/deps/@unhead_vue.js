...
var EventHandlersPlugin = defineHeadPlugin((head) => ({
  hooks: {
    ...
    "dom:renderTag": function(ctx) {
      ...
      const handler = (k2) => {
        var _a, _b;
        return (_b = (_a = ctx.tag._eventHandlers) == null ? void 0 : _a[k2]) == null ? void 0 : _b.call(ctx.$el, new Event(k2.replace("on", "")));
      };
      for (const k2 of Object.keys($el.dataset).filter((k22) => NetworkEvents.includes(k22)))
        handler(k2);
  ...
  script.loadPromise = new Promise((resolve, reject) => {
    const removeHook2 = head.hooks.hook("script:updated", ({ script: script2 }) => {
      ...
      if (script2.id === id && (script2.status === "loaded" || script2.status === "error")) {
        script2.status === "loaded" && resolve((_a2 = options.use) == null ? void 0 : _a2.call(options));
