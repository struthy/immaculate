...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file://C:/webdev/Tutorials/nuxt-blog/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://C:/webdev/Tutorials/nuxt-blog/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://C:/webdev/Tutorials/nuxt-blog/node_modules/devalue/index.js';
import destr from 'file://C:/webdev/Tutorials/nuxt-blog/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash } from 'file://C:/webdev/Tutorials/nuxt-blog/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://C:/webdev/Tutorials/nuxt-blog/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file://C:/webdev/Tutorials/nuxt-blog/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file://C:/webdev/Tutorials/nuxt-blog/node_modules/@unhead/ssr/dist/index.mjs';
...
import { consola } from 'file://C:/webdev/Tutorials/nuxt-blog/node_modules/consola/dist/index.mjs';
import devalue from 'file://C:/webdev/Tutorials/nuxt-blog/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { getContext } from 'file://C:/webdev/Tutorials/nuxt-blog/node_modules/unctx/dist/index.mjs';
import { version, unref } from 'file://C:/webdev/Tutorials/nuxt-blog/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file://C:/webdev/Tutorials/nuxt-blog/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://C:/webdev/Tutorials/nuxt-blog/node_modules/@unhead/shared/dist/index.mjs';
...
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\webdev\\Tutorials\\nuxt-blog\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _Jdetz6Ui0o = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "C:/webdev/Tutorials/nuxt-blog";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _hHTbjY1Cs6 = (nitroApp) => {
...
const _lazy_0wGJtq = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_0wGJtq, lazy: true, middleware: false, method: undefined },
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"Prismic + Nuxt blog example"},{"name":"format-detection","content":"telephone=no"}],"link":[{"rel":"icon","type":"image/png","href":"/favicon.png"}],"style":[],"script":[],"noscript":[],"title":"Prismic + Nuxt blog example","htmlAttrs":{"lang":"en"}};
...
const getClientManifest = () => import('file://C:/webdev/Tutorials/nuxt-blog/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://C:/webdev/Tutorials/nuxt-blog/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
