...
const _routes = [
  ...
  },
  {
    ...
    component: () => import('./_uid_-DXcfbyXl.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./_uid_-CddUfRlq.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./index-6dhppHCN.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./slice-simulator-DY3EVvjp.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./default-Dh1wKSr-.mjs').then((m) => m.default || m)
};
...
export { PrismicText as P, SliceZone as S, _export_sfc as _, __nuxt_component_0$1 as a, usePrismic as b, useRouter as c, useRoute as d, entry$1 as default, useAsyncData as e, PrismicImage as f, PrismicRichText as g, PrismicLink as h, defineSliceZoneComponents as i, getSliceComponentProps as j, useHead as u };
