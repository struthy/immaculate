...
import { b as usePrismic, d as useRoute, e as useAsyncData, u as useHead, a as __nuxt_component_0, P as PrismicText, f as PrismicImage, g as PrismicRichText, S as SliceZone, h as PrismicLink } from "../server.mjs";
import { _ as __nuxt_component_1 } from "./HorizontalDivider-B6YJmzjp.js";
import { _ as _sfc_main$2 } from "./Heading-B2lfgbt7.js";
import { u as useSettings } from "./useSettings-CLIk7AWv.js";
import { defineComponent, computed, withCtx, createTextVNode, createVNode, unref, toDisplayString, openBlock, createBlock, Fragment, renderList, useSSRContext } from "vue";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_PrismicText, {
              field: (_a2 = unref(article)) == null ? void 0 : _a2.data.title,
              wrapper: "h1",
      ...
      _push(ssrRenderComponent(_component_SliceZone, {
        slices: ((_a = unref(article)) == null ? void 0 : _a.data.slices) ?? [],
...
//# sourceMappingURL=_uid_-CddUfRlq.js.map
